...
description: |-
  ...
  bare-metal hardware.
summary: |-
  The runbook for operating and managing virtual machine-based servers using
  `libvirtd` on bare-metal hardware. Virtual machines will provide most of the
  nodes for all clusters (Vault, Consul, etcd, etc.) and kubernetes nodes.
tags:
  - runbook
  - virtual-machines
  - installation
...
{{< alert "edit" >}}
Provide an overview of the virtual machines; noting it's general setup and
purpose.
{{< /alert >}}
