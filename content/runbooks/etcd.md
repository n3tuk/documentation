...
date: 2023-07-19T13:50:50+01:00
description: |-
  Runbook for the general maintenance and management of the etcd Cluster for the
  n3tuk Organisation.
summary: |-
  Runbook for the general maintenance and management of the `etcd` Cluster for
  the `n3tuk` Organisation, providing centralised configuration for the
  Kubernetes cluster.
tags:
  - runbook
  - clusters
...
{{< alert "edit" >}}
Provide an overview of the `etcd` service; noting it's general setup and
purpose.
{{< /alert >}}
